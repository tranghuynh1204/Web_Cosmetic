...
function addColumn() {
  $("#classification-table thead tr:first").append(
    "<th><button class='fas fa-trash trash-icon' onclick='deleteColumn(this)'></button></th>"
  );
  $("#classification-table thead tr:last").append(
    "<th><input type='text' value='Đơn vị'></th>"
  );
...
function addRow() {
  ...
  newRow.append(
    $(
      '<td><button onclick="deleteRow(this)" class="fas fa-trash trash-icon"></button></td>'
    )
  );
...
function deleteRow(button) {
  ...
  if ($("#classification-table tbody tr").length === 1) {
...
function checkEmptyCells() {
  ...
  var seen = {};
  $("#classification-table thead tr:last")
    .find("input")
    .each(function () {
